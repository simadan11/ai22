...
def install_hint() -> str:
    ...
    lines = [
        ...
        "    Самый простой способ — скачай cloudflared.exe и положи",
        "    в домашнюю папку (C:\\Users\\<имя>\\cloudflared.exe) — EDIT найдёт его сам.",
        "    Прямая ссылка:",
        "      https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-windows-amd64.exe",
        "      (переименуй файл в cloudflared.exe)",
        "",
        "    Или через winget (PowerShell/CMD):",
